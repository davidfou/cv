...
const ABOUT_ME =
  "Software engineer with 14 years of experience who cares as much about how a team operates as what it ships. I'm mostly influenced by Extreme Programming, Building Evolutionary Architecture and Team Topologies. In practice, this means I push for short feedback loops, shared ownership, and disciplined habits like testing after every regression. I've swung between IC and management roles throughout my career and see both as complementary — each makes me better at the other. I'm at my best when I can help a team deliver steadily without heroics.";
const WORK_ITEMS = [
  {
    key: "segments",
    startMonth: "May",
...
function MainSection({ title, children }: MainSectionProps) {
  return (
    <section>
      ...
      <div className="border-2 border-r-0 border-slate-300 bg-slate-100 p-4 rounded-l-md text-sm space-y-4">
        {children}
      </div>
    </section>
  );
  ...
  return (
    <div className="text-left">
      ...
      <div className="text-slate-500 mb-1">
        <MapPinIcon className="h-4 w-4 inline-block -ml-0.5 mr-1 stroke-1" />
        {location}{" "}
        {link && (
